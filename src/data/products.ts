...
export const products: Product[] = [
  ...
  // === Impact Drop Arm Tank ===
  {
    ...
    colorHex: "#000000",
    description:
      "Tank top con diseño de manga caída para entrenamientos intensos. Material ligero y transpirable.",
    discount: 20,
    gender: "hombre",
    images: [
      "/images/impact-tank/BLACK/1.webp",
      "/images/impact-tank/BLACK/2.webp",
      "/images/impact-tank/BLACK/3.webp",
      "/images/impact-tank/BLACK/4.webp",
      "/images/impact-tank/BLACK/5.webp",
      "/images/impact-tank/BLACK/6.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Tank top con diseño de manga caída para entrenamientos intensos",
    sizes: [
      { size: "S", stock: 1 },
      { size: "M", stock: 4 },
      { size: "L", stock: 2 },
  ...
  // === British Iron OVER ===
  {
    ...
    colorHex: "#000000",
    description:
      "Estilos versátiles y gráficos auténticos para levantamiento. Mejora tus básicos con nuestros diseños gráficos.",
    discount: 10,
    gender: "hombre",
    images: [
      "/images/british-iron/1.webp",
      "/images/british-iron/2.webp",
      "/images/british-iron/3.webp",
      "/images/british-iron/4.webp",
      "/images/british-iron/5.webp",
      "/images/british-iron/6.webp",
      "/images/british-iron/7.webp",
    ],
  ...
  // === Crest Oversized Fit ===
  {
    ...
    colorHex: "#d5596a",
    description:
      "DÍA DE DESCANSO AL ESTILO CREST Cómodo y con estilo casual, puedes usar Crest en cualquier lugar y combinarlo con todo. • Interior de forro polar cepillado, suave y cómodo • Logo bordado duradero que resistirá cada uso • Capucha ajustable con cordón • Bolsillo tipo canguro para guardar tus cosas TALLA Y AJUSTE • Corte holgado • El modelo mide 183 cm y usa talla M MATERIALES Y CUIDADO • 80% Algodón, 20% Poliéster",
    discount: 10,
    gender: "hombre",
    images: [
      "/images/hoodie-oversized/ROSA/1.webp",
      "/images/hoodie-oversized/ROSA/2.webp",
      "/images/hoodie-oversized/ROSA/3.webp",
      "/images/hoodie-oversized/ROSA/4.webp",
    ],
    ...
    price: 40000,
    shortDescription:
      "Crest: cómodo, estiloso y versátil, con felpa suave, logo bordado duradero, capucha ajustable y bolsillo canguro. 80% algodón, 20% poliéster.",
    sizes: [
      { size: "S", stock: 0 },
      { size: "M", stock: 2 },
      { size: "L", stock: 0 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/hoodie-oversized/BEIGE/1.webp",
      "/images/hoodie-oversized/BEIGE/2.webp",
      "/images/hoodie-oversized/BEIGE/3.webp",
      "/images/hoodie-oversized/BEIGE/4.webp",
      "/images/hoodie-oversized/BEIGE/5.webp",
      "/images/hoodie-oversized/BEIGE/6.webp",
    ],
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/hoodie-oversized/VINO/1.webp",
      "/images/hoodie-oversized/VINO/2.webp",
      "/images/hoodie-oversized/VINO/3.webp",
      "/images/hoodie-oversized/VINO/4.webp",
    ],
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/hoodie-oversized/NAVY/1.webp",
      "/images/hoodie-oversized/NAVY/2.webp",
      "/images/hoodie-oversized/NAVY/3.webp",
      "/images/hoodie-oversized/NAVY/4.webp",
      "/images/hoodie-oversized/NAVY/5.webp",
    ],
  ...
  },
  {
    ...
    price: 40000,
    shortDescription:
      "Crest Hoodie: esencial y versátil, con interior cálido, capucha ajustable, diseño minimalista y logo bordado duradero. 80% algodón, 20% poliéster.",
    sizes: [
      { size: "S", stock: 0 },
      { size: "M", stock: 1 },
      { size: "L", stock: 0 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/hoodie-oversized/NEGRO/1.webp",
      "/images/hoodie-oversized/NEGRO/2.webp",
      "/images/hoodie-oversized/NEGRO/3.webp",
      "/images/hoodie-oversized/NEGRO/4.webp",
      "/images/hoodie-oversized/NEGRO/5.webp",
    ],
  ...
  // === Power Zip Hoodie ===
  {
    ...
    colorHex: "#a49a87",
    description:
      "Poleron con cierre para entrenamiento de alta calidad y durabilidad.",
    discount: 20,
    gender: "hombre",
    images: [
      "/images/hoodie-zip-power/MARRON/1.webp",
      "/images/hoodie-zip-power/MARRON/2.webp",
      "/images/hoodie-zip-power/MARRON/3.webp",
      "/images/hoodie-zip-power/MARRON/4.webp",
      "/images/hoodie-zip-power/MARRON/5.webp",
      "/images/hoodie-zip-power/MARRON/6.webp",
    ],
  ...
  // === Rest Day Essential Crew ===
  {
    ...
    colorHex: "#000000",
    description:
      "Poleron crew diseñado para máxima comodidad en días de descanso.",
    discount: 20,
    gender: "hombre",
    images: [
      "/images/rest-day/NEGRO/1.webp",
      "/images/rest-day/NEGRO/2.webp",
      "/images/rest-day/NEGRO/3.webp",
      "/images/rest-day/NEGRO/4.webp",
      "/images/rest-day/NEGRO/5.webp",
    ],
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/rest-day/GRIS/1.webp",
      "/images/rest-day/GRIS/2.webp",
      "/images/rest-day/GRIS/3.webp",
      "/images/rest-day/GRIS/4.webp",
      "/images/rest-day/GRIS/5.webp",
      "/images/rest-day/GRIS/6.webp",
    ],
  ...
  // === Crest Long Sleeve T-Shirt ===
  {
    ...
    colorHex: "#d5d7d8",
    description:
      "Cómodamente constante y casualmente elegante, puedes usar Crest en cualquier lugar y combinarlo con todo. Logo bordado duradero que resistirá cada uso. Tela de algodón suave y cómoda. TALLA Y AJUSTE Ajuste regular. El modelo mide 1.85 m y usa talla M. MATERIALES Y CUIDADO 100% Algodón.",
    gender: "hombre",
    images: [
      "/images/long-sleeve/GRIS/1.webp",
      "/images/long-sleeve/GRIS/2.webp",
      "/images/long-sleeve/GRIS/3.webp",
      "/images/long-sleeve/GRIS/4.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Polera gris manga larga, cómoda y elegante para cualquier ocasión.",
    sizes: [
      { size: "S", stock: 0 },
      { size: "M", stock: 1 },
      { size: "L", stock: 1 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/long-sleeve/NEGRO/1.webp",
      "/images/long-sleeve/NEGRO/2.webp",
      "/images/long-sleeve/NEGRO/3.webp",
      "/images/long-sleeve/NEGRO/4.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Polera negra manga larga, resistente y estilizada para un look casual duradero.",
    sizes: [
      { size: "S", stock: 0 },
      { size: "M", stock: 7 },
      { size: "L", stock: 0 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/long-sleeve/BLANCO/1.webp",
      "/images/long-sleeve/BLANCO/2.webp",
      "/images/long-sleeve/BLANCO/3.webp",
      "/images/long-sleeve/BLANCO/4.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Polera blanca manga larga, suave y cómoda para un estilo elegante y casual.",
    sizes: [
      { size: "S", stock: 0 },
      { size: "M", stock: 1 },
      { size: "L", stock: 2 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/long-sleeve/NAVY/1.webp",
      "/images/long-sleeve/NAVY/2.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Polera navy manga larga, elegante y duradera para un look casual sofisticado.",
    sizes: [
      { size: "S", stock: 2 },
      { size: "M", stock: 0 },
      { size: "L", stock: 0 },
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/long-sleeve/BLUE/1.webp",
      "/images/long-sleeve/BLUE/2.webp",
      "/images/long-sleeve/BLUE/3.webp",
      "/images/long-sleeve/BLUE/4.webp",
    ],
    ...
    price: 30000,
    shortDescription:
      "Polera azul manga larga, fresca y cómoda para un estilo casual diario.",
    sizes: [
      { size: "S", stock: 1 },
      { size: "M", stock: 3 },
      { size: "L", stock: 0 },
  ...
  // === Essential Oversized T-Shirt ===
  {
    ...
    gender: "hombre",
    images: [
      "/images/essential-oversized/NAVY/1.webp",
      "/images/essential-oversized/NAVY/2.webp",
      "/images/essential-oversized/NAVY/3.webp",
      "/images/essential-oversized/NAVY/4.webp",
    ],
    ogimage: "",
    link: "",
    measurements: "",
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/essential-oversized/BLUE/1.webp",
      "/images/essential-oversized/BLUE/2.webp",
      "/images/essential-oversized/BLUE/3.webp",
      "/images/essential-oversized/BLUE/4.webp",
    ],
...

  {
    ...
    gender: "hombre",
    images: [
      "/images/essential-oversized/NEGRO/1.webp",
      "/images/essential-oversized/NEGRO/2.webp",
      "/images/essential-oversized/NEGRO/3.webp",
      "/images/essential-oversized/NEGRO/4.webp",
    ],
  ...
  // === Polera con letras en la espalda ===
  {
    ...
    colorHex: "#000000",
    description:
      "Polera con diseño de letras en la espalda, estilo moderno y deportivo.",
    discount: 0,
    gender: "hombre",
    images: [
      "/images/power-tshirt/NEGRO/1.webp",
      "/images/power-tshirt/NEGRO/2.webp",
      "/images/power-tshirt/NEGRO/3.webp",
      "/images/power-tshirt/NEGRO/4.webp",
      "/images/power-tshirt/NEGRO/5.webp",
      "/images/power-tshirt/NEGRO/6.webp",
    ],
  ...
  // === Crest Short Algodón ===
  {
    ...
    colorHex: "#000000",
    description:
      "Shorts de algodón con logo Crest, comodidad y estilo para tu entrenamiento.",
    discount: 0,
    gender: "hombre",
    images: [
      "/images/shorts/crest/NEGRO/1.webp",
      "/images/shorts/crest/NEGRO/2.webp",
      "/images/shorts/crest/NEGRO/3.webp",
      "/images/shorts/crest/NEGRO/4.webp",
      "/images/shorts/crest/NEGRO/5.webp",
    ],
  ...
  // === Sport 7 Short ===
  {
    ...
    colorHex: "#6c6b70",
    description:
      "Shorts deportivos de 7 pulgadas, diseñados para máximo rendimiento.",
    discount: 0,
    gender: "hombre",
    images: [
      "/images/shorts/sport7/GRIS/1.webp",
      "/images/shorts/sport7/GRIS/2.webp",
      "/images/shorts/sport7/GRIS/3.webp",
      "/images/shorts/sport7/GRIS/4.webp",
      "/images/shorts/sport7/GRIS/5.webp",
    ],
  ...
  // === Arrival 7 Shorts ===
  {
    ...
    colorHex: "#223649",
    description:
      "Shorts deportivos versátiles de 7 pulgadas, perfectos para cualquier actividad.",
    discount: 0,
    gender: "hombre",
    images: [
      "/images/shorts/arrival7/NAVY/1.webp",
      "/images/shorts/arrival7/NAVY/2.webp",
      "/images/shorts/arrival7/NAVY/3.webp",
    ],
  ...
  },
  {
    ...
    gender: "hombre",
    images: [
      "/images/shorts/arrival7/NEGRO/1.webp",
      "/images/shorts/arrival7/NEGRO/2.webp",
      "/images/shorts/arrival7/NEGRO/3.webp",
      "/images/shorts/arrival7/NEGRO/4.webp",
      "/images/shorts/arrival7/NEGRO/5.webp",
      "/images/shorts/arrival7/NEGRO/6.webp",
    ],
  ...
  // === Silicone Lifting Straps ===
  {
    ...
    colorHex: "#000000",
    description:
      "Straps de silicona para levantamiento de peso, máximo agarre y durabilidad.",
    discount: 0,
    gender: "unisex",
    images: [
      "/images/straps/NEGRO/1.webp",
      "/images/straps/NEGRO/2.webp",
      "/images/straps/NEGRO/3.webp",
    ],
  ...
  // === Active Holdall Medium ===
  {
    ...
    colorHex: "#b98987",
    description:
      "Bolso deportivo de tamaño mediano, perfecto para el gimnasio.",
    discount: 0,
    gender: "mujer",
    images: [
      "/images/bags/active-medium/ROSA/1.webp",
      "/images/bags/active-medium/ROSA/2.webp",
      "/images/bags/active-medium/ROSA/3.webp",
      "/images/bags/active-medium/ROSA/4.webp",
      "/images/bags/active-medium/ROSA/5.webp",
      "/images/bags/active-medium/ROSA/6.webp",
    ],
...

  {
    ...
    colorHex: "#000000",
    description:
      "Ropa interior suave, elástica y cómoda con cintura ajustable, disponible en pack de 5.",
    discount: 0,
    gender: "unisex",
  ...
  // === Calcetas con Logo Gymshark ===
  {
    ...
    gender: "unisex",
    images: [
      "/images/socks/crew/NEGRO/1.webp",
      "/images/socks/crew/NEGRO/2.webp",
    ],
  ...
  },
  {
    ...
    gender: "unisex",
    images: [
      "/images/socks/crew/GRIS/1.webp",
      "/images/socks/crew/GRIS/2.webp",
    ],
  ...
  },
  {
    ...
    gender: "unisex",
    images: [
      "/images/socks/crew/BLANCO/1.webp",
      "/images/socks/crew/BLANCO/2.webp",
    ],
